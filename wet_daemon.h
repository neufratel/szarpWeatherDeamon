 ...
 * parcook line demons
 */
class WeatherDaemon :public BaseDaemon{
public:
	/** 
	 ...
	 */
	 int Init(int argc, const char *argv[] , TSzarpConfig* sz_cfg = NULL , int dev_index = -1 );

	/** 
	 * @brief Wait for next cycle. 
	 */
	 void Wait( time_t interval = DAEMON_INTERVAL );
...
protected:
	 ...
	 * @return 0 on success, 1 otherwise
	 */
	 int Init( const char*name , int argc, const char *argv[], TSzarpConfig* sz_cfg = NULL , int dev_index = -1 );
	/** 
	 ...
	 * @return 0 on success, 1 otherwise
	 */
	 int InitConfig( const char*name , int argc, const char *argv[], TSzarpConfig* sz_cfg , int dev_index = -1 );
	/** 
	 ...
	 * @return 0 on success, 1 otherwise
	 */
	 int ParseConfig(DaemonConfig * cfg) = 0;
